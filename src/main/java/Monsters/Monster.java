 ...
 * @author Khanh Nguyen
 * @since 7/12/2024
 * This is the abstract Monsters.Monster parent class
 */
public abstract class Monster {
     ...
     * rand.nextInt(n) returns a number between 0-n
    ...
    /**
     * This method calculates if the creature has > 0 hp.
     * If the damage value is greater than 0 the damage amount is
     * subtract from current hp value
     ...
     * @return Integer results of the attack method of the Attack object of the current monster on the target.
     */
